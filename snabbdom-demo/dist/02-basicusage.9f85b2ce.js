...
var vnode = (0, _h.h)('div#container', [(0, _h.h)('h1', 'this is good study'), (0, _h.h)('h2', 'hhhhhhh今天天气好')]);
var app = document.querySelector('#app');
var oldVnode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _h.h)('div#container', [(0, _h.h)('h1', 'Hello world'), (0, _h.h)('h2', '今天下雨啦')]);
  oldVnode = patch(oldVnode, vnode);
}, 2000);
setTimeout(function () {
  patch(oldVnode, (0, _h.h)('!')); // 清空 没有任何内容的注释节点
}, 4000);
